...
export const VisualSearchModal: React.FC<VisualSearchModalProps> = ({
  ...
  return (
    ...
    >
      <div
        className="theme-card border rounded-3xl w-[95vw] sm:w-[90vw] md:w-full max-w-lg p-5 sm:p-6 shadow-2xl animate-in fade-in zoom-in-95 duration-200 max-h-[90vh] overflow-y-auto"
